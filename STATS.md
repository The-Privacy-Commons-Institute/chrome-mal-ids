...
> Auto-generated 2026-09-12 07:53 UTC · [Full list](https://github.com/The-Privacy-Commons-Institute/chrome-mal-ids)
...
| Metric | Count |
|--------|-------|
| Total malicious extensions | **7,321** |
| Unique campaigns | **34** |
| Entries without campaign attribution | **5,817** |
...
| Most recent discovery | **2026-09-12** |
...
| adware | 2,471 (33.8%) |
| unknown | 2,447 (33.4%) |
| data-theft | 2,225 (30.4%) |
| spyware | 1,644 (22.5%) |
| browser-hijack | 1,087 (14.8%) |
| click-fraud | 388 (5.3%) |
| credential-theft | 306 (4.2%) |
| session-hijack | 194 (2.6%) |
| malware | 140 (1.9%) |
...
A total of **34** distinct campaigns are tracked, covering **1,504** of 7,321 entries.

The remaining **5,817** entries carry a threat classification but no campaign attribution — typically bulk IOC-feed imports where the source recorded a category (adware, policy violation, search hijacking) rather than naming an operation. Their classification is preserved in `THREAT-TYPE`; they are excluded here because a category is not a campaign.
...
| Method | Extensions |
|--------|-----------|
| csv_import+ThreatType_Classified | 3,672 (50.2%) |
| Delta_Import+Store_Enrichment | 1,392 (19.0%) |
| Google_Search | 940 (12.8%) |
| csv_import | 839 (11.5%) |
| csv_import+ThreatType_Fallback | 134 (1.8%) |
| Delta_Import+Store_Enrichment+ThreatType_Classified | 113 (1.5%) |
| PDF_Import | 107 (1.5%) |

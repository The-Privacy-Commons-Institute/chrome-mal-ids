...
> Auto-generated 2026-08-17 19:40 UTC · [Full list](https://github.com/The-Privacy-Commons-Institute/chrome-mal-ids)
...
| Metric | Count |
|--------|-------|
| Total malicious extensions | **6,460** |
| Unique campaigns | **54** |
...
| Most recent discovery | **2026-08-15** |
...
|-------------|-----------|
| adware | 2,432 (37.6%) |
| data-theft | 1,946 (30.1%) |
| unknown | 1,938 (30.0%) |
| spyware | 1,412 (21.9%) |
| browser-hijack | 1,060 (16.4%) |
| click-fraud | 373 (5.8%) |
...
| Policy Violation | 636 |
| Malware | 392 |
| Unknown | 361 |
| Bundling Unwanted Software | 239 |
...
| Method | Extensions |
|--------|-----------|
| csv_import+ThreatType_Classified | 3,405 (52.7%) |
| Delta_Import+Store_Enrichment | 1,466 (22.7%) |

...
> Auto-generated 2026-09-07 19:20 UTC · [Full list](https://github.com/The-Privacy-Commons-Institute/chrome-mal-ids)
...
| Metric | Count |
|--------|-------|
| Total malicious extensions | **7,197** |
| Unique campaigns | **34** |
| Entries without campaign attribution | **5,693** |
...
| Most recent discovery | **2026-09-07** |
...
| Method | Extensions |
|--------|-----------|
| csv_import+ThreatType_Classified | 3,648 (50.7%) |

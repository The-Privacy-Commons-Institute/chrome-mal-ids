...
> **⚠ Delta import verification status** — 1,796 entries sourced from third-party sources (`CONTRIB-METHOD=Delta_Import` or `csv_import`) have undergone Stage 5A static behavioral analysis; 91.5% exhibit confirmed malicious or elevated-risk patterns. Third-party sources include a one-time bulk delta import (1,498 entries) and ongoing ingestion from toborrm9/malicious_extension_sentry (298 entries to date, MIT license). See [Data Quality](#data-quality) and [CHANGELOG.md](CHANGELOG.md).
